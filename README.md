...
I Build mainly **AI-powered SaaS platforms** and **financial technology solutions** with a focus on **security, scalability, and clean architecture**. With expertise spanning from Flask API development to WEB3 payment integration, helping businesses with automate processes and build MVP or robust digital infrastructure.
